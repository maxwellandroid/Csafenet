...
public class HSEAlertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsealerts);
        listBulletins=(ListView)findViewById(R.id.list_bulletins);
        tv_norecords=(TextView)findViewById(R.id.tet_no_record);
        layout_home=(LinearLayout)findViewById(R.id.layout_home) ;
        layout_progress=(RelativeLayout)findViewById(R.id.rela_animation) ;
        new GetBulletinsOperation().execute();
    }
    ...
    private class GetBulletinsOperation extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(HSEAlertsActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(HSEAlertsActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.hseAlertsUrl, new Response.Listener<String>() {
                    ...
                    if(!response.matches("")){
                        ...
                        try {
                            ...
                            if(jsonObject.has("Alerts")){
                                ...
                                JSONArray bulletinArray=jsonObject.getJSONArray("Alerts");
                                ...
                                if(bulletinModulesList.size()>0){
                                    ...
                                    adapter=new BulletinAdapter(HSEAlertsActivity.this,bulletinModulesList);
