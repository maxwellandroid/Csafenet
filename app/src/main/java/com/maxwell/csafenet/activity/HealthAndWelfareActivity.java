...
public class HealthAndWelfareActivity extends AppCompatActivity {
    ...
    private class ViewMyObservation extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(HealthAndWelfareActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(HealthAndWelfareActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.healthandwelfareurl, new Response.Listener<String>() {
...
*//*
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    String desacription=object.getString("description");
                                    Spanned sp = Html.fromHtml(desacription);
                                    tv_emergency_type.setText(sp);
                            ...
                            if(jsonObject.has("Policys")){
                                ...
                                if(policyDetailsModelList.size()>0){
                                    for (int i=0;i<policyDetailsModelList.size();i++){
                                        final  ImageView imageView=new ImageView(HealthAndWelfareActivity.this);
                                        Glide.with(HealthAndWelfareActivity.this)
                                    ...
                                    final TextView rowTextView = new TextView(HealthAndWelfareActivity.this);
    ...
    public void initializeViews(){
        ...
        if(title.matches("Emergency & Crisis Management")){
            tv_title.setText(title);
            tv_description.setVisibility(View.GONE);
            tv_heading1.setText("Our Emergency and Crisis Management Policies");
            tv_heading2.setText("Emergency and Crisis Management News Letter");
            tv_heading3.setText("Emergency and Crisis Management Flowcharts");
            tv_heading4.setVisibility(View.GONE);
            tv_heading5.setText("Key Documentation");
            tv_heading6.setText("Emergency and Crisis Management Risk Assessment");
            tv_heading7.setText("Emergency and Crisis Management Reports");
            tv_heading3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.flowchart,0,0,0);
            tv_heading7.setCompoundDrawablesWithIntrinsicBounds(R.drawable.result,0,0,0);
            banner.setImageDrawable(getResources().getDrawable(R.drawable.crisismgt));
            iv_policy.setVisibility(View.GONE);
            tv_newsletter1.setText("");
            tv_newsletter2.setVisibility(View.GONE);
            tv_newsletter3.setVisibility(View.GONE);
            tv_newsletter4.setVisibility(View.GONE);
            tv_alerts1.setText("");
            tv_alerts2.setVisibility(View.GONE);
            tv_alerts3.setVisibility(View.GONE);
            tv_alerts4.setVisibility(View.GONE);
            tv_alerts5.setVisibility(View.GONE);
        }
    }
}
