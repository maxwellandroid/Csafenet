...
public class ViewAuditModules extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_audit_modules);
        ...
        preferences= PreferenceManager.getDefaultSharedPreferences(ViewAuditModules.this);
    ...
    public void getAuditModule(){
        RequestQueue requestQueue = Volley.newRequestQueue(ViewAuditModules.this);
        JsonObjectRequest getRequest = new JsonObjectRequest(Request. Method.GET, StringConstants.mainUrl + StringConstants.viewAuditModuleUrl+field_id, null,
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(response.has("Audit")){

                                JSONArray complianceArray=response.getJSONArray("Audit");
                                ...
                                if(answersDetailsModelList.size()>0){
                                    ...
                                    adapter=new ComplianceViewAdapter(ViewAuditModules.this,complianceModuleViewModelList);
