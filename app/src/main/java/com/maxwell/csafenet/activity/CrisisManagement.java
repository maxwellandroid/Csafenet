...
public class CrisisManagement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crisis_management);
    ...
    private class GetSecuirityManagemnetDetails extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(CrisisManagement.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(CrisisManagement.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.emergencyManagmentUrl, new Response.Listener<String>() {
                            ...
                            if(jsonObject.has("Policys")){
                                ...
                                if(policyDetailsModelList.size()>0){
                                    for (int i=0;i<policyDetailsModelList.size();i++){
                                        final  ImageView imageView=new ImageView(CrisisManagement.this);
                                        Glide.with(CrisisManagement.this)
                                    ...
                                    final TextView rowTextView = new TextView(CrisisManagement.this);
