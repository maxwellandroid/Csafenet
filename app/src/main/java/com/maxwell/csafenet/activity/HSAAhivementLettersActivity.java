...
public class HSAAhivementLettersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   String screenName=getIntent().getStringExtra("Screen");
      tv_screen_name.setText("HSE Achievements Letter");
    ...
    private class GetAwardPhotosOperation extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(HSAAhivementLettersActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(HSAAhivementLettersActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.hseAcheivmentlettersUrl, new Response.Listener<String>() {
                    ...
                    if(!response.matches("")){
                        ...
                        try {
                            ...
                            if(jsonObject.has("achievements_letter")){
                                ...
                                confinedArray=jsonObject.getJSONArray("achievements_letter");
                                ...
                                mAdapter=new AcheivementLettersAdapter(getApplicationContext(),awardDetailsList);
