...
public class CorrectiveActionsReportGeneratorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corrective_actions_report_generator);
        ...
        layout_progress=(RelativeLayout)findViewById(R.id.rela_animation) ;
        {
            ...
            tv001.setText(" Department Manager ");
            ...
            tv03.setText(" Implementing Authority ");
            ...
            tv003.setText(" Proposed Completion Issued Date ");
        ...
        new ViewCorrectiveReport().execute();
    ...
    private class ViewCorrectiveReport extends AsyncTask<String, Void,String> {

        ProgressDialog pDialog=new ProgressDialog(CorrectiveActionsReportGeneratorActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(CorrectiveActionsReportGeneratorActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl +StringConstants.correctiveActionReportUrl , new Response.Listener<String>() {
                @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
                @Override
                public void onResponse(String response) {
                    ...
                    if(!response.matches("")) {
                        try {
                            ...
                            if (jsonObject.has("correction_action")) {
                                JSONArray jsonArray = new JSONArray();
                                incidentManagementModuleList=new ArrayList<>();
                                jsonArray = jsonObject.getJSONArray("correction_action");
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    JSONObject dataObject = jsonArray.getJSONObject(i);
                                    module=new IncidentManagementModule();
                                    module.setDateOfIncidet(dataObject.getString("date_of_incident"));
                                    module.setTeamLeader(dataObject.getString("team_lead"));
                                    module.setDepartmentManager(dataObject.getString("dep_manager"));
                                    module.setImplementingAuthority(dataObject.getString("autority"));
                                    module.setProposedConclusionIssueDate(dataObject.getString("proposed_completion"));
                                    module.setDateClosed(dataObject.getString("date_closed"));
                                ...
                                if (incidentManagementModuleList.size() > 0) {
                                    for (int i = 0; i < incidentManagementModuleList.size(); i++) {
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv02.setText(incidentManagementModuleList.get(i).getTeamLeader());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv004.setText(incidentManagementModuleList.get(i).getDepartmentManager());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv0004.setText(incidentManagementModuleList.get(i).getImplementingAuthority());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv06.setText(incidentManagementModuleList.get(i).getProposedConclusionIssueDate());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv05.setText(incidentManagementModuleList.get(i).getDateClosed());
