...
public class EnvironmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetEnviromentDetails().execute();
    }
    public  void back(View view){
      onBackPressed();
    }

    private class GetEnviromentDetails extends AsyncTask<String, Void,String> {

        ProgressDialog pDialog=new ProgressDialog(EnvironmentActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(EnvironmentActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.enviromentUrl, new Response.Listener<String>() {
                            ...
                            if(jsonObject.has("Policys")){
                                ...
                                if(policyDetailsModelList.size()>0){
                                    for (int i=0;i<policyDetailsModelList.size();i++){
                                        final  ImageView imageView=new ImageView(EnvironmentActivity.this);
                                        Glide.with(EnvironmentActivity.this)
                                    ...
                                    final TextView rowTextView = new TextView(EnvironmentActivity.this);
