...
public class ImmediateNotificationSystemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_immediate_notification_system);
        ...
        new VIewImmediateNotifications().execute();


    }

    private class VIewImmediateNotifications extends AsyncTask<String, Void,String> {

        ProgressDialog pDialog=new ProgressDialog(ImmediateNotificationSystemActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(ImmediateNotificationSystemActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl +StringConstants.immediateNotificationUrl , new Response.Listener<String>() {
                @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
                @Override
                    ...
                    if(!response.matches("")) {
                        try {
                            ...
                            if (jsonObject.has("incident")) {
                                ...
                                jsonArray = jsonObject.getJSONArray("incident");
                                incidentManagementModuleList=new ArrayList<>();
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    JSONObject dataObject = jsonArray.getJSONObject(i);
                                    module=new IncidentManagementModule();
                                    module.setDate(dataObject.getString("date_val"));
                                    module.setTime(dataObject.getString("time_val"));
                                    module.setProject(dataObject.getString("project"));
                                    module.setLocation(dataObject.getString("location"));
                                    module.setActionBy(dataObject.getString("fname"));
                                ...
                                if (incidentManagementModuleList.size() > 0) {
                                    for (int i = 0; i < incidentManagementModuleList.size(); i++) {
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv00.setText(incidentManagementModuleList.get(i).getDate());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv02.setText(incidentManagementModuleList.get(i).getTime());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv004.setText(incidentManagementModuleList.get(i).getProject());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv0004.setText(incidentManagementModuleList.get(i).getLocation());
                                        ...
                                        //tv7.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                                        tv06.setText(incidentManagementModuleList.get(i).getActionBy());
