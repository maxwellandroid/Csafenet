...
public class CAHSAPolicies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetHSEPolicies().execute();



    }

    private class GetHSEPolicies extends AsyncTask<String, Void,String> {

        ProgressDialog pDialog=new ProgressDialog(CAHSAPolicies.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(CAHSAPolicies.this);
        @Override
                    ...
                    if(!response.matches("")){
                        ...
                        try {
                            ...
                            if(jsonObject.has("assessment")){
                                ...
                                if(object.has("HSE Policy")){
                                    JSONArray jsonArray=object.getJSONArray("HSE Policy");
                                    ...
                                    if(docDetailsListView.size()>0){
                                        {
                                            ...
                                            TableRow tbrow0 = new TableRow(CAHSAPolicies.this);
                                            tbrow0.setBackground(getResources().getDrawable(R.drawable.rounded_edittext));
                                            TextView tv0 = new TextView(CAHSAPolicies.this);
                                           ...
                                           /* TextView tv1 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv1);*/
                                            TextView tv2 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv2);
                                            TextView tv3 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv3);
                                            TextView tv4 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv4);
                                            TextView tv5 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv5);
                                            TextView tv6 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv6);
                                            TextView tv7 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv7);
                                            TextView tv8 = new TextView(CAHSAPolicies.this);
                                            ...
                                            for(int i=0;i<docDetailsListView.size();i++){
                                                TableRow row=new TableRow(CAHSAPolicies.this);
                                                TextView tv00 = new TextView(CAHSAPolicies.this);
                                               ...
                                               /* TextView tv01 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv01);*/
                                                TextView tv02 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv02);
                                                TextView tv03 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv03);
                                                TextView tv04 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv04);
                                                TextView tv05 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv05);
                                                TextView tv06 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv06);
                                                TextView tv07 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv07);
                                                TextView tv08 = new TextView(CAHSAPolicies.this);
