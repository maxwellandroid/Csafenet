...
public class HSERiskManagmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hserisk_managment);
    ...
    private class GetSecuirityManagemnetDetails extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(HSERiskManagmentActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(HSERiskManagmentActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.riskManagmentUrl, new Response.Listener<String>() {
                            ...
                            if(jsonObject.has("Policys")){
                                ...
                                if(policyDetailsModelList.size()>0){
                                    for (int i=0;i<policyDetailsModelList.size();i++){
                                        final  ImageView imageView=new ImageView(HSERiskManagmentActivity.this);
                                        Glide.with(HSERiskManagmentActivity.this)
                                    ...
                                    final TextView rowTextView = new TextView(HSERiskManagmentActivity.this);
