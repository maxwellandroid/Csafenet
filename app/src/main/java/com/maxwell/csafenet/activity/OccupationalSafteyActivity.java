...
public class OccupationalSafteyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_occupational_saftey);
    ...
    private class ViewMyObservation extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(OccupationalSafteyActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(OccupationalSafteyActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.ocupationalsafetyUrl, new Response.Listener<String>() {
                            ...
                            if(jsonObject.has("Policys")){
                                ...
                                if(policyDetailsModelList.size()>0){
                                    for (int i=0;i<policyDetailsModelList.size();i++){
                                        final  ImageView imageView=new ImageView(OccupationalSafteyActivity.this);
                                        Glide.with(OccupationalSafteyActivity.this)
                                    ...
                                    final TextView rowTextView = new TextView(OccupationalSafteyActivity.this);
