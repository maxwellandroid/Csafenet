...
public class SecurityManagmentActivity extends AppCompatActivity {
    ...
    private class GetSecuirityManagemnetDetails extends AsyncTask<String, Void,String> {
        ...
        ProgressDialog pDialog=new ProgressDialog(SecurityManagmentActivity.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(SecurityManagmentActivity.this);
        @Override
        protected String doInBackground(String... strings) {
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.secuirityManagmentUrl, new Response.Listener<String>() {
                            ...
                            if(jsonObject.has("Policys")){
                                ...
                                if(policyDetailsModelList.size()>0){
                                    for (int i=0;i<policyDetailsModelList.size();i++){
                                        final  ImageView imageView=new ImageView(SecurityManagmentActivity.this);
                                        Glide.with(SecurityManagmentActivity.this)
                                    ...
                                    final TextView rowTextView = new TextView(SecurityManagmentActivity.this);
