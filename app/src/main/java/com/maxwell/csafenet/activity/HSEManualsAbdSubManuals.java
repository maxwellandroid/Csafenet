...
public class HSEManualsAbdSubManuals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsemanuals_abd_sub_manuals);
        ...
        new GetHSEManualsSubManuals().execute();

    }
    private class GetHSEManualsSubManuals extends AsyncTask<String, Void,String> {

        ProgressDialog pDialog=new ProgressDialog(HSEManualsAbdSubManuals.this);
        String result="";
        RequestQueue requestQueue = Volley.newRequestQueue(HSEManualsAbdSubManuals.this);
        @Override
                    ...
                    if(!response.matches("")){
                        ...
                        try {
                            ...
                            if(jsonObject.has("assessment")){
                                ...
                                if(object.has("HSE Manuals & Sub Manuals")){
                                    JSONArray jsonArray=object.getJSONArray("HSE Manuals & Sub Manuals");
                                    ...
                                    if(docDetailsListView.size()>0){
                                        {
                                            ...
                                            TableRow tbrow0 = new TableRow(HSEManualsAbdSubManuals.this);
                                            tbrow0.setBackground(getResources().getDrawable(R.drawable.rounded_edittext));
                                            TextView tv0 = new TextView(HSEManualsAbdSubManuals.this);
                                           ...
                                           /* TextView tv1 = new TextView(CAHSAPolicies.this);
                                            ...
                                            tbrow0.addView(tv1);*/
                                            TextView tv2 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            tbrow0.addView(tv2);
                                            TextView tv3 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            tbrow0.addView(tv3);
                                            TextView tv4 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            tbrow0.addView(tv4);
                                            TextView tv5 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            tbrow0.addView(tv5);
                                            TextView tv6 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            tbrow0.addView(tv6);
                                            TextView tv7 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            tbrow0.addView(tv7);
                                            TextView tv8 = new TextView(HSEManualsAbdSubManuals.this);
                                            ...
                                            for(int i=0;i<docDetailsListView.size();i++){
                                                TableRow row=new TableRow(HSEManualsAbdSubManuals.this);
                                                TextView tv00 = new TextView(HSEManualsAbdSubManuals.this);
                                               ...
                                               /* TextView tv01 = new TextView(CAHSAPolicies.this);
                                                ...
                                                row.addView(tv01);*/
                                                TextView tv02 = new TextView(HSEManualsAbdSubManuals.this);
                                                ...
                                                row.addView(tv02);
                                                TextView tv03 = new TextView(HSEManualsAbdSubManuals.this);
                                                ...
                                                row.addView(tv03);
                                                TextView tv04 = new TextView(HSEManualsAbdSubManuals.this);
                                                ...
                                                row.addView(tv04);
                                                TextView tv05 = new TextView(HSEManualsAbdSubManuals.this);
                                                ...
                                                row.addView(tv05);
                                                TextView tv06 = new TextView(HSEManualsAbdSubManuals.this);
                                                ...
                                                row.addView(tv06);
                                                TextView tv07 = new TextView(HSEManualsAbdSubManuals.this);
                                                ...
                                                row.addView(tv07);
                                                TextView tv08 = new TextView(HSEManualsAbdSubManuals.this);
