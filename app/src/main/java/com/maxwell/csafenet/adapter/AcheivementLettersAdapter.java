...
public class AcheivementLettersAdapter extends RecyclerView.Adapter<AcheivementLettersAdapter.ViewHolder>{

    List<AwardDetails> awardDetailsList;
    Context context;

    public AcheivementLettersAdapter(Context mcontext, List<AwardDetails> awardDetailsList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_awardletters_row, viewGroup, false);
...
//        viewHolder.tv_view_file.setTag(i);
        viewHolder.tv_view_file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(peoplesModel.getImageUrl()));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_date,tv_description,tv_view_file;
        ...
        public ViewHolder(View itemView) {
            ...
            this.tv_view_file=(TextView)itemView.findViewById(R.id.text_view_images);
